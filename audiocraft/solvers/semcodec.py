...
class SemCompressionSolver(base.StandardSolver):
    ...
    def __init__(self, cfg: omegaconf.DictConfig):
        ...
        self.balancer = builders.get_semcodec_balancer(loss_weights, self.cfg.balancer)
    ...
    def build_model(self):
        ...
        # state_dict = torch.load('/home/jongmin/userdata/SemCodec/encodec_32khz_whole_nonHF.pt')
        # print("loading state dict")
        # self.load_my_state_dict(state_dict)
        # print("DONE!~ loaded state dict")
    ...
    def build_dataloaders(self):
        ...
        self.dataloaders = builders.get_audio_datasets(self.cfg, builders.DatasetType.MIDI)
    ...
    def run_step(self, idx: int, batch: torch.Tensor, metrics: dict):
        ...
        for loss_name, criterion in self.aux_losses.items():
            if loss_name == 'midi':
                loss = criterion(midi_y_pred, midi_y.to(torch.float32))
            else:
        ...
        if self.is_training:
            ...
            metrics['g_loss'] = self.balancer.backward(balanced_losses, y_pred, midi_y_pred)
